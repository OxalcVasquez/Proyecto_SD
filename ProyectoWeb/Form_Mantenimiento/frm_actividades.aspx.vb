...
Public Class frm_actividades
    ...
    Protected Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        Try
            ...
            obj_e_actividad.p_fecha = cal_fecha.Text
    ...
    Protected Sub dgv_actividades_SelectedIndexChanged(sender As Object, e As EventArgs) Handles dgv_actividad.SelectedIndexChanged
        Try
            lbl_codigo.Text = dgv_actividad.SelectedRow.Cells(1).Text
            cbo_tipo.SelectedItem.Value = dgv_actividad.SelectedRow.Cells(2).Text
            txt_actividad.Text = dgv_actividad.SelectedRow.Cells(3).Text
            txt_descripcion.Text = dgv_actividad.SelectedRow.Cells(4).Text
            cal_fecha.Text = Convert.ToDateTime(dgv_actividad.SelectedRow.Cells(5).Text).ToString("yyyy-MM-dd")
